...
public class RefundRequest {
  ...
  public RefundRequest amountInCents(Integer amountInCents) {
  ...
  **/
  @Schema(example = "1000", required = true, description = "Amount to refund in cents (euros).")
   ...
   * @return description
  **/
  @Schema(example = "Refunded 10.00 for broken product.", required = true, description = "Description of the refund.")
  ...
  public RefundRequest referenceId(String referenceId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.amountInCents, refundRequest.amountInCents) &&
        Objects.equals(this.description, refundRequest.description) &&
        Objects.equals(this.referenceId, refundRequest.referenceId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amountInCents, description, referenceId);
  }
