...
public class PaymentRequestCreationRequest {
  ...
  public PaymentRequestCreationRequest amountInCents(Integer amountInCents) {
  ...
  **/
  @Schema(example = "1500", description = "Amount in cents of the payment request (euros). If this value is not specified, an open payment request will be created.")
  ...
  public PaymentRequestCreationRequest description(String description) {
  ...
  **/
  ...
  public PaymentRequestCreationRequest referenceId(String referenceId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentRequestCreationRequest paymentRequestCreationRequest = (PaymentRequestCreationRequest) o;
    return Objects.equals(this.amountInCents, paymentRequestCreationRequest.amountInCents) &&
        Objects.equals(this.description, paymentRequestCreationRequest.description) &&
        Objects.equals(this.expiryDate, paymentRequestCreationRequest.expiryDate) &&
        Objects.equals(this.referenceId, paymentRequestCreationRequest.referenceId);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentRequestCreationRequest {\n");
