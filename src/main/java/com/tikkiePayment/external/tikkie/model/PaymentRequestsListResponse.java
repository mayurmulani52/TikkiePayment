...
public class PaymentRequestsListResponse {
  ...
  public PaymentRequestsListResponse paymentRequests(List<PaymentRequest> paymentRequests) {
    this.paymentRequests = paymentRequests;
    return this;
  }

  public PaymentRequestsListResponse addPaymentRequestsItem(PaymentRequest paymentRequestsItem) {
    if (this.paymentRequests == null) {
      this.paymentRequests = new ArrayList<PaymentRequest>();
    }
  ...
  **/
  @Schema(description = "Payment requests")
  ...
  public PaymentRequestsListResponse totalElementCount(Integer totalElementCount) {
    this.totalElementCount = totalElementCount;
    return this;
  }

   /**
   * Total amount of payment requests which match the parameters provided.
   * @return totalElementCount
  **/
  @Schema(example = "75", description = "Total amount of payment requests which match the parameters provided.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentRequestsListResponse inlineResponse200 = (PaymentRequestsListResponse) o;
    return Objects.equals(this.paymentRequests, inlineResponse200.paymentRequests) &&
        Objects.equals(this.totalElementCount, inlineResponse200.totalElementCount);
  }
