...
public class PaymentRequest extends PaymentRequestCreationResponse {
  @SerializedName("numberOfPayments")
  private Integer numberOfPayments = null;

  @SerializedName("totalAmountPaidInCents")
  private Long totalAmountPaidInCents = null;

  public PaymentRequest numberOfPayments(Integer numberOfPayments) {
  ...
  **/
  @Schema(example = "2", description = "Number of payments which have been collected on this payment request.")
  ...
  public PaymentRequest totalAmountPaidInCents(Long totalAmountPaidInCents) {
   ...
   * @return totalAmountPaidInCents
  **/
  @Schema(example = "3000", description = "Total amount, in cents, which has been collected on this payment request")
  public Long getTotalAmountPaidInCents() {
    return totalAmountPaidInCents;
  }

  public void setTotalAmountPaidInCents(Long totalAmountPaidInCents) {
    this.totalAmountPaidInCents = totalAmountPaidInCents;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.numberOfPayments, paymentRequest.numberOfPayments) &&
        Objects.equals(this.totalAmountPaidInCents, paymentRequest.totalAmountPaidInCents) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(numberOfPayments, totalAmountPaidInCents, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("    totalAmountPaidInCents: ").append(toIndentedString(totalAmountPaidInCents)).append("\n");
    sb.append("}");
    return sb.toString();
  }
