...
public class SubscribeRequest {
  ...
  public SubscribeRequest url(String url) {
    this.url = url;
    return this;
  }

   /**
   * URL where notifications must be sent using a webhook or callback.
   * @return url
  **/
  @Schema(example = "https://www.example.com/notification", required = true, description = "URL where notifications must be sent using a webhook or callback.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.url, subscribeRequest.url);
  }
