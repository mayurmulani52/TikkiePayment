...
public class InlineResponse201 {
  ...
  public InlineResponse201 subscriptionId(UUID subscriptionId) {
    this.subscriptionId = subscriptionId;
    return this;
  }

   /**
   * Unique identifier for a subscription. This will be sent with the user&#x27;s payment request notification.
   * @return subscriptionId
  **/
  @Schema(example = "e0111835-e8df-4070-874a-f12cf3f77e39", description = "Unique identifier for a subscription. This will be sent with the user's payment request notification.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.subscriptionId, inlineResponse201.subscriptionId);
  }
