...
public class RefundNotification extends PaymentNotification implements OneOfNotification {
  @SerializedName("refundToken")
  private String refundToken = null;

  public RefundNotification refundToken(String refundToken) {
   ...
   * @return refundToken
  **/
  @Schema(example = "abcdzr8hnVWTgXXcFRLUMc", required = true, description = "Unique token identifying this refund.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.refundToken, refundNotification.refundToken) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(refundToken, super.hashCode());
  }
