...
public class File {
  ...
  public File type(String type) {
   ...
   /**
   * Filetype of the bundle.
   * @return type
  **/
  @Schema(example = "camt053", description = "Filetype of the bundle.")
  ...
  public File url(String url) {
   ...
   /**
   * The link where the file is available for download.
   * @return url
  **/
  @Schema(example = "https://example.com/bundle.xml", description = "The link where the file is available for download.")
