...
public class PaymentNotification extends BaseNotification implements OneOfNotification {
  ...
  public PaymentNotification paymentRequestToken(String paymentRequestToken) {
    this.paymentRequestToken = paymentRequestToken;
    return this;
  }

   /**
   * Unique token identifying this payment request.
   * @return paymentRequestToken
  **/
  @Schema(example = "qzdnzr8hnVWTgXXcFRLUMc", required = true, description = "Unique token identifying this payment request.")
  ...
  public PaymentNotification paymentToken(String paymentToken) {
   ...
   * @return paymentToken
  **/
  @Schema(example = "21ef7413-cc3c-4c80-9272-6710fada28e4", required = true, description = "Unique token identifying this payment.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentNotification paymentNotification = (PaymentNotification) o;
    return Objects.equals(this.paymentRequestToken, paymentNotification.paymentRequestToken) &&
        Objects.equals(this.paymentToken, paymentNotification.paymentToken) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentRequestToken, paymentToken, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentNotification {\n");
