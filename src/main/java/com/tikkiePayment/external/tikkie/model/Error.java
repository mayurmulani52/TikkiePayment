...
public class Error {
   ...
   * @return code
  **/
  @Schema(example = "PAYMENT_REQUEST_TOKEN_INVALID", required = true, description = "Unique error code.")
   ...
   * @return message
  **/
  @Schema(example = "paymentRequestToken is in an invalid format.", required = true, description = "Message describing the error.")
   ...
   * @return reference
  **/
  @Schema(example = "https://developer.abnamro.com", description = "reference to documentation")
   ...
   * @return status
  **/
  @Schema(example = "400", required = true, description = "HTTP Status code.")
   ...
   * @return traceId
  **/
  @Schema(example = "5e332871-7f05-4de6-975e-27de0a369629", description = "Id to trace the request.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, message, reference, status, traceId);
  }
