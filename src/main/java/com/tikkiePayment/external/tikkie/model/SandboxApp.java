...
public class SandboxApp {
  ...
  public SandboxApp appToken(UUID appToken) {
   ...
   * @return appToken
  **/
  @Schema(example = "935059a6-58b3-4f8d-a021-7bdda0d8d6ad", description = "`appToken` to use in other requests.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SandboxApp sandboxApp = (SandboxApp) o;
    return Objects.equals(this.appToken, sandboxApp.appToken);
  }
