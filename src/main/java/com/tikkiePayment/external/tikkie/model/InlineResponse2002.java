...
public class InlineResponse2002 {
  ...
  private List<TransactionBundle> bundles = null;

  @SerializedName("totalElementCount")
  private Integer totalElementCount = null;

  public InlineResponse2002 bundles(List<TransactionBundle> bundles) {
    this.bundles = bundles;
    return this;
  }

  public InlineResponse2002 addBundlesItem(TransactionBundle bundlesItem) {
    if (this.bundles == null) {
      this.bundles = new ArrayList<TransactionBundle>();
    }
   ...
   * @return bundles
  **/
  @Schema(description = "Bundles")
  public List<TransactionBundle> getBundles() {
    return bundles;
  }

  public void setBundles(List<TransactionBundle> bundles) {
    this.bundles = bundles;
  }

  public InlineResponse2002 totalElementCount(Integer totalElementCount) {
    this.totalElementCount = totalElementCount;
    return this;
  }

   /**
   * Total amount of bundles which match the parameters provided.
   * @return totalElementCount
  **/
  @Schema(example = "75", description = "Total amount of bundles which match the parameters provided.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.bundles, inlineResponse2002.bundles) &&
        Objects.equals(this.totalElementCount, inlineResponse2002.totalElementCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bundles, totalElementCount);
  }
