...
public class BundledPayoutNotification extends BaseNotification implements OneOfNotification {
  @SerializedName("bundleId")
  private UUID bundleId = null;

  public BundledPayoutNotification bundleId(UUID bundleId) {
   ...
   * @return bundleId
  **/
  @Schema(example = "af8fa035-3275-44fc-9a9b-a38c02efa114", required = true, description = "Unique identifier for this bundle.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BundledPayoutNotification bundledPayoutNotification = (BundledPayoutNotification) o;
    return Objects.equals(this.bundleId, bundledPayoutNotification.bundleId) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bundleId, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class BundledPayoutNotification {\n");
